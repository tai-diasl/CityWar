...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        pygame.time.set_timer(EVENT_TIMEOUT, TIMEOUT_STEP)  # está valendo 100ms
    ...
    def run(self, player_score: list[int]):
        ...
        clock = pygame.time.Clock()  # faz com que a função rode em um tempo específico
        while True:
            clock.tick(60)  # define o fps (quanto maior o fps, mais rápido vai executar)
